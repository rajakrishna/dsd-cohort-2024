...
export default function AdminPage() {
	...
	return (
		<>
			<h1 className='text-black text-center pb-4 font-bold'>Today's Appointments</h1>
					...
					{displayedRows.map((app, index) => {
						return (
							<tr className='hover' key={uuidv4()}>
								<th className='px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900' key={uuidv4()}>
									{indexOfFirstRow + index + 1}
								</th>
								<td className='px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900' key={uuidv4()}>
									{app.name}
								</td>
								<td className='px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900' key={uuidv4()}>
									{timeSlots[app.time]}
