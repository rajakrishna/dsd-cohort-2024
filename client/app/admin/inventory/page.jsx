...
export default function InventoryPage() {
  ...
  const handleQuantityChange = (e, partId, delta = 0) => {
    ...
    setPartsData((prevData) =>
      prevData.map((part) =>
        part.partId === partId ? { ...part, quantity: value } : part
      )
    );
  };
  return (
              ...
              <tr key={part.partId}>
                ...
                <td>
                  <div className="inline-flex">
                    <button
                      onClick={(e) => handleQuantityChange(e, part.partId, 1)}
                    ...
                    <input
                      ...
                      name="quantity"
                      value={part.quantity}
                      onChange={(e) => handleQuantityChange(e, part.partId)}
