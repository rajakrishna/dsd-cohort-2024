    ...
    <div className="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <form onSubmit={signInFormSubmitHandler}>
            ...
            <div className="mb-6">
                ...
                <input type="password" id="password" className="mt-1 p-2 w-full border rounded-md" onChange={(e) => setSigninPassword(e.target.value)} required />
            </div>
        ...
        <button onClick={handleGoogleSignIn} className="mt-6 w-full p-2 bg-red-500 text-white rounded-md flex items-center justify-center hover:bg-red-600">
